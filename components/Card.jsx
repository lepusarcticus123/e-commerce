...
export default function Card({ item }) {
  ...
  return (
    <div className=" inline-block align-middle relative overflow-hidden bg-white shadow-lg hover:shadow-blue-300/60 rounded-lg transition-all duration-300 ease-in-out">
      {data ? (
